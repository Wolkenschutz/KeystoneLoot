...
L["Baganator: The position in the bags is set in the Baganator settings under Icons."] = "Baganator: A posição nas bolsas é definida nas configurações do Baganator, em Icons.";
...
L["When joining a group"] = "Ao entrar em um grupo";
L["When the group is full"] = "Quando o grupo estiver completo";
...
L["Auto role check"] = "Confirmação automática de função";
L["Accepts the role check window for you. The roles used are the ones you have selected in the Dungeon Finder."] = "Confirma a janela de verificação de funções para você. São usadas as funções que você selecionou no Localizador de Masmorras.";
L["Mythic+ only"] = "Somente Mítica+";
L["Only when your group signs up for Mythic+ in the group finder."] = "Somente quando seu grupo se inscreve para uma Mítica+ no localizador de grupos.";
L["Everywhere"] = "Em todo lugar";
L["Every role check, including Dungeon Finder and Raid Finder queues."] = "Todas as verificações de função, incluindo filas do Localizador de Masmorras e de Raides.";
L["Window scale"] = "Escala da janela";
L["Owned items"] = "Itens que você possui";
L["Shows a checkmark on items you already own, starting at the selected upgrade track. Bank items count once you have opened your bank at least once."] = "Mostra uma marca nos itens que você já possui a partir da trilha de aprimoramento selecionada. Os itens no banco contam depois de você abrir o banco pelo menos uma vez.";
