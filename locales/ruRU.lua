...
L["Baganator: The position in the bags is set in the Baganator settings under Icons."] = "Baganator: положение в сумках задаётся в настройках Baganator в разделе Icons.";
...
L["When joining a group"] = "При вступлении в группу";
L["When the group is full"] = "Когда группа заполнена";
...
L["Auto role check"] = "Автоподтверждение роли";
L["Accepts the role check window for you. The roles used are the ones you have selected in the Dungeon Finder."] = "Подтверждает окно проверки ролей за Вас. Используются роли, выбранные Вами в поиске подземелий.";
L["Mythic+ only"] = "Только М+";
...
L["Owned items"] = "Имеющиеся предметы";
L["Shows a checkmark on items you already own, starting at the selected upgrade track. Bank items count once you have opened your bank at least once."] = "Показывает галочку на предметах, которые у вас уже есть, начиная с выбранного уровня улучшения. Предметы в банке учитываются после того, как вы хотя бы раз откроете банк.";
