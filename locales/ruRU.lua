...
L["Merge keeps your existing favorites and only adds new items. Overwrite replaces all of them."] = "Объединить сохраняет ваше текущее избранное и добавляет только новые предметы. Перезаписать заменяет всё.";
...
L["All items are already in your favorites."] = "Все предметы уже в вашем избранном.";
