...
L["Automatic Keystone response is currently restricted by game rules."] = "La respuesta automática de sigilo está actualmente restringida por las reglas del juego.";
