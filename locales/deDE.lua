...
L["Baganator: The position in the bags is set in the Baganator settings under Icons."] = "Baganator: Die Position in den Taschen wird in den Baganator-Einstellungen unter Icons festgelegt.";
...
L["When joining a group"] = "Beim Beitreten einer Gruppe";
L["When the group is full"] = "Wenn die Gruppe voll ist";
