...
if (Addon.API.GetTocVersion() >= 100200) then
	DROPDOWN_CATEGORY_RANKS = {
		veteran = {
			...
			{ itemLevel = 454, bonusID = 'veteran-5', text = ITEM_POOR_COLOR_CODE..'454|r | '..ITEM_UPGRADE },
			{ itemLevel = 457, bonusID = 'veteran-6', text = ITEM_POOR_COLOR_CODE..'457|r | '..ITEM_UPGRADE },
			{ itemLevel = 460, bonusID = 'veteran-7', text = ITEM_POOR_COLOR_CODE..'460|r | '..ITEM_UPGRADE },
			{ itemLevel = 463, bonusID = 'veteran-8', text = ITEM_POOR_COLOR_CODE..'463|r | '..ITEM_UPGRADE }
		},
		champion = {
			{ itemLevel = 454, bonusID = 'champion-1', text = ITEM_POOR_COLOR_CODE..'454|r | +9 +10' },
