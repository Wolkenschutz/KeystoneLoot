...
local function CreateTrackEntry(ilvl, bonusId, quality, suffix)
    return {
        ilvl = ilvl,
        bonusId = bonusId,
...
KeystoneLoot.UpgradeTracks = {
    dungeon = {
        ...
        hero = {
            CreateTrackEntry(259, 12793, Enum.ItemQuality.Rare, "+6 +7"),
            CreateTrackEntry(263, 12794, Enum.ItemQuality.Rare, "+8 +9"),
            CreateTrackEntry(266, 12795, Enum.ItemQuality.Rare, "+10"),
            CreateTrackEntry(269, 12796, Enum.ItemQuality.Rare, ITEM_UPGRADE),
        ...
        greatvault = {
            CreateTrackEntry(272, 12801, Enum.ItemQuality.Epic, "+10"),
            CreateTrackEntry(276, 12802, Enum.ItemQuality.Epic, ITEM_UPGRADE),
            CreateTrackEntry(279, 12803, Enum.ItemQuality.Epic, ITEM_UPGRADE),
            CreateTrackEntry(282, 12804, Enum.ItemQuality.Epic, ITEM_UPGRADE),
