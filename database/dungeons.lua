...
local _dungeonList = {
  [15] = {
    { --[[name = "Hallen der Sühne",]] challengeModeId = 378, teleportSpellId = 354465, bgTexture = 3759908, lootTable = { 178812, 178813, 178814, 178815, 178816, 178817, 178818, 178819, 178820, 178821, 178822, 178823, 178824, 178825, 178826, 178827, 178828, 178829, 178830, 178831, 178832, 178833, 178834 } },
    ...
    { --[[name = "Priorat der Heiligen Flamme",]] challengeModeId = 499, teleportSpellId = 445444, bgTexture = 5912551, lootTable = { 219308, 219309, 219310, 221116, 221117, 221118, 221119, 221120, 221121, 221122, 221123, 221124, 221125, 221126, 221127, 221128, 221129, 221130, 221131, 221200, 221203 } },
    { --[[name = "Ara-Kara, Stadt der Echos",]] challengeModeId = 503, teleportSpellId = 445417, bgTexture = 5912546, lootTable = { 219314, 219316, 219317, 221150, 221151, 221152, 221153, 221154, 221155, 221156, 221157, 221158, 221159, 221160, 221161, 221162, 221163, 221164, 221165 } },
    ...
    { --[[name = "Operation: Schleuse",]] challengeModeId = 525, teleportSpellId = 1216786, bgTexture = 6422412, lootTable = { 232541, 232542, 232543, 232545, 234490, 234491, 234492, 234493, 234494, 234495, 234496, 234497, 234498, 234499, 234500, 234501, 234502, 234503, 234504, 234505, 234506, 234507, 236768 } },
...
local _itemlevels = {
	[15] = {
		{ id = 'champion', text = 'Champion', entries = {
			{ itemLevel = 681, bonusId = 11977, text = ITEM_GOOD_COLOR_CODE..'681|r | +0' },
			{ itemLevel = 684, bonusId = 11978, text = ITEM_GOOD_COLOR_CODE..'684|r | +2 +3' },
			{ itemLevel = 688, bonusId = 11979, text = ITEM_GOOD_COLOR_CODE..'688|r | +4' },
			{ itemLevel = 691, bonusId = 11980, text = ITEM_GOOD_COLOR_CODE..'691|r | +5' },
		...
		{ id = 'hero', text = 'Hero', entries = {
			{ itemLevel = 694, bonusId = 11985, text = ITEM_SUPERIOR_COLOR_CODE..'694|r | +6 +7' },
			{ itemLevel = 697, bonusId = 11986, text = ITEM_SUPERIOR_COLOR_CODE..'697|r | +8 +9' },
			{ itemLevel = 701, bonusId = 11987, text = ITEM_SUPERIOR_COLOR_CODE..'701|r | +10' },
			{ itemLevel = 704, bonusId = 11988, text = ITEM_SUPERIOR_COLOR_CODE..'704|r | '..ITEM_UPGRADE },
		...
		{ id = 'myth', text = 'Great Vault', entries = {
			{ itemLevel = 707, bonusId = 11991, text = ITEM_EPIC_COLOR_CODE..'707|r | +10' },
			{ itemLevel = 710, bonusId = 11992, text = ITEM_EPIC_COLOR_CODE..'710|r | '..ITEM_UPGRADE },
			{ itemLevel = 714, bonusId = 11993, text = ITEM_EPIC_COLOR_CODE..'714|r | '..ITEM_UPGRADE },
			{ itemLevel = 717, bonusId = 11994, text = ITEM_EPIC_COLOR_CODE..'717|r | '..ITEM_UPGRADE },
